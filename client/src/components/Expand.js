...
export const Expand = ({ url }) => {
  ...
  useEffect(() => {
    axios.get(`http://localhost:8000/expand/${id}`)
    .then(res=>{
      setuser(res.data);
    })
        ...
        <div className="expandbox">
          ...
          <div className="expandright">
            ...
            <div className="expandbtns">
                <NavLink className='expandeditbtn' to={`/edit/${user._id}`}> <div className='heart'><i className="fa-solid fa-pen-to-square"></i> &nbsp; EDIT</div></NavLink>
